...
async function scheduleTimer() {
    ...
    let xJConf = {
        ...
        dinnerTime: { begin: 9, time: 120 - 5 },
        abnormalClassTime: [{ begin: 12, time: 40 }],
        abnormalRestingTime: [{ begin: 3, time: 10 }, { begin: 7, time: 15 },]
    }
    ...
    let dJConf = {
        ...
        lunchTime: { begin: 4, time: 3 * 60 - 10 },
        dinnerTime: { begin: 8, time: 50 },
        // abnormalClassTime: [{ begin: 1, time: 30 }],
        // abnormalRestingTime: [{ begin: 8, time: 10 }, { begin: 10, time: 15 }]
    }
