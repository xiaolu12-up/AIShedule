...
async function scheduleTimer() {
    ...
    let xJConf = {
        ...
        lunchTime: { begin: 4, time: 60 + 40 },
        dinnerTime: { begin: 9, time: 15 },
        abnormalClassTime: [{ begin: 9, time: 60 + 35 }],
        abnormalRestingTime: [{ begin: 6, time: 15 }, { begin: 4, time: 60 + 40 }, { begin: 7, time: 10 }, { begin: 8, time: 10 }, { begin: 9, time: 15 }]
    }
