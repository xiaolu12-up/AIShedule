...
function scheduleHtmlParser(html) {
  ...
  let Conf = {           //夏季配置
    ...
    lunchTime: { begin: 6, time: 60 + 30 }, //午休时间:{begin:Number//开始的节数,time:number//时长}:单位：min:可选
    dinnerTime: { begin: 11, time: 60 },   //晚餐时间 :{begin:Number//开始的节数,time:number//时长}:单位：min:可选
