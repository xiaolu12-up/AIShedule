...
async function scheduleTimer() {
    ...
    let xJConf = {
        ...
        longRestingTime: 10,
        shortRestingTime: 5,
        longRestingTimeBegin: [2, 3, 7],
        lunchTime: { begin: 5, time: 2 * 60 + 20 },
        dinnerTime: { begin: 9, time: 115 },
        // abnormalClassTime: [{ begin: 4, time: 55 },]
        abnormalRestingTime: [{ begin: 7, time: 15 }]
    }
    ...
    let dJConf = {
        ...
        // abnormalClassTime: [{ begin: 11, time: 20 }, { begin: 12, time: 20 },],
        // abnormalRestingTime: [{ begin: 6, time: 20 }, { begin: 10, time: 10 }]
    }
